...
INPUT_DIM = 2  # frameSize
TIME_STEPS = 20  # frameCount
...
if __name__ == '__main__':
    ...
    for i in range(300):
        ...
        attention_vector = np.mean(get_activations(m, testing_inputs_1, print_shape_only=True, layer_name='attention_vec')[0], axis=2).squeeze()
